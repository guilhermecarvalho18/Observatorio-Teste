...
from src.etl.data_transform import transformar_atracacao_fato, transformar_carga_fato
from src.etl.data_loading import carregar_atracacao_sql, carregar_carga_sql
...
def run_etl():
    ...
    output_atracacao = "datalake/processed/atracacao_fato"
    output_carga = "datalake/processed/carga_fato"
    ...
    # Transformação da tabela carga_fato
    ...
    carregar_atracacao_sql(input_path=output_atracacao, jdbc_url=jdbc_url, table_name="atracacao_fato", connection_properties=connection_properties)
    
    print("Carregando dados de carga_fato no SQL Server...")
    carregar_carga_sql(input_path=output_carga, jdbc_url=jdbc_url, table_name="carga_fato", connection_properties=connection_properties)
